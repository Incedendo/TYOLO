...
# test = fo.load_dataset("coco-2017-train-3")
# test.delete()
...
# print("printing list of dataset after loading and saving....")
# print(fo.config.dataset_zoo_dir)
...
print("printing list of dataset after extracting traffic lights...")
print(fo.config.dataset_zoo_dir)
print(fo.list_datasets())
